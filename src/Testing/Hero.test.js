...
test('renders heading tag content', () => {
    ...
    expect(linkElement).toHaveTextContent("Services Delivered");
  ...
  test('renders heading tag content', () => {
    ...
    expect(linkElement).toBeInTheDocument();
    expect(linkElement).toHaveTextContent("Clients Served with Excellence");
  ...
  test('renders heading tag content', () => {
    ...
    expect(linkElement).toBeInTheDocument();
    expect(linkElement).toHaveTextContent("Industry Awards Earned");
  });
