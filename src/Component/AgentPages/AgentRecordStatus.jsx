...
//       <h3 className="text-xl font-semibold mt-6 mb-2">Onboarding Employees</h3>
...
//       <h3 className="text-xl font-semibold mt-6 mb-2">Experienced Employees</h3>
//       <table className="min-w-full bg-white border border-gray-200">
//         <thead className="bg-black text-white">
//           <tr>
//             <th className="py-3 px-4 border-b">Employee</th>
...
//     return report ? report.report : 'No report available';
//   };
