...
const HeadAgentNavbar = () => {
  ...
  const Menus = [
    { title: "Add Agents", src: "Chart", alt: "inbox_image", path: "/addagent" },
    { title: "Assign tasks", src: "User", alt: "account_image", path: "/assigntasks" },
    { title: "Task Status", src: "User", alt: "account_image", path: "/taskstatus" },
  ];
