...
const [toastMessage, setToastMessage] = useState('');
    ...
    const Menus = [
        { title: "Records To Verify", src: "User", alt: "account_image", path: "/headhrpendingverificationrecords" },
        { title: "Records Status", src: "Chart", alt: "inbox_image", path: "/recordstatus" },
        // { title: "Record Report", src: "User", alt: "account_image", path: "/recordreport" },
    ...
    useEffect(() => {
        ...
        navigate('/headhrpendingverificationrecords');
    }, []);
