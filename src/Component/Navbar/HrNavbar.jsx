...
//   const Menus = [
//     { title: "Dashboard", src: "Chart", alt: "inbox_image", path: "/viewemployee" },
//     { title: "Appointment", src: "User", alt: "account_image", path: "/viewemployee" },
...
const [toastMessage, setToastMessage] = useState('');
  ...
  const Menus = [
    { title: "View Employee", src: "Chart", alt: "inbox_image", path: "/viewemployee" },
    { title: "Request Status", src: "User", alt: "account_image", path: "/pendingverificationrecord" },
    // { title: "Verification Report", src: "User", alt: "inbox_image", path: "/verificationreport" },
  ];
  ...
  useEffect(() => {
    const adminId = sessionStorage.getItem('patientid');
    if (adminId) {
      axios.get(`http://localhost:1225/admin/${adminId}`)
        .then((response) => {
