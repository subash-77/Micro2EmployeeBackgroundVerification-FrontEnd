...
const RecordStatus = () => {
  ...
  const fetchRecords = () => {
    ...
    fetch(`http://localhost:1230/hr/allOnBoardingEmployee`)
    ...
    fetch(`http://localhost:1230/hr/allOnBoardingExpEmployee`)
      .then(response => response.json())
      .then(data => {
        setExpRecords(data);
        console.log(data);
  ...
  return (
    ...
    //   <h3 className="text-xl font-semibold mt-6 mb-2">Experience Employees Record</h3>
    //   <table className="min-w-full bg-white border border-gray-200">
    //     <thead className="bg-black text-white">
    //       <tr>
    //         <th className="py-3 px-4 border-b">Employee</th>
